...
public class CalisanDetaylari extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        String tcno = calisanid.getText();

        if (ae.getSource() == search) {
            String query = "select * from calisanlar where calisanid = '"+tcno+"'";
            try {
                Conn c = new Conn();
                Connection conn = c.getConnection();
